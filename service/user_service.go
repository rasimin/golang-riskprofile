...
type IUserService interface {
	...
	GetUserByID(ctx context.Context, id int) (entity.SubmissionUserView, error)
...
func (s *userService) CreateUser(ctx context.Context, user *entity.User) (entity.User, error) {
	...
	if err != nil {
		return entity.User{}, fmt.Errorf("gagal membuat penggunax: %v", err)
	}
	return createdUser, nil
}

// GetUserByID mendapatkan pengguna berdasarkan ID
func (s *userService) GetUserByID(ctx context.Context, id int) (entity.SubmissionUserView, error) {
	// Memanggil GetUserByID dari repository untuk mendapatkan pengguna berdasarkan ID
	user, err := s.userRepo.GetUserByID(ctx, id)
	if err != nil {
		return entity.SubmissionUserView{}, fmt.Errorf("gagal mendapatkan pengguna berdasarkan ID: %v", err)
	}
	return user, nil
}
